package com.cbt.tests.Assignment2;
...
public class EmailSignUp {
    ...
    public void emailSignUp() {
       ...
       BrowserUtils.wait(2);
        ...
        WebElement confirmationEmail = driver.findElement(By.xpath("//span[starts-with(text(),'do-not-reply@practice.cybertekschool.com')]"));
        String confirmationEmailAdress = confirmationEmail.getText();

        String expectedEmailAdress = "do-not-reply@practice.cybertekschool.com";
        Assert.assertEquals(confirmationEmailAdress,expectedEmailAdress,"Another mail Adress");
